...
use algebra::{PairingEngine, AffineCurve, Zero, One, ProjectiveCurve};
use std::ops::Mul;
...
impl<E: PairingEngine> PublicParameters<E> {
    ...
    pub fn setup<R: RngCore>(
        ...
        let mut normalised_g = E::G1Projective::batch_normalization_into_affine(&powers_of_g);
    ...
    pub fn trim(&self, truncated_degree: usize) -> Result<(CommitKey<E>, OpeningKey<E>), Error> {
