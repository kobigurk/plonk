...
use algebra::{PrimeField, PairingEngine, Zero, One, Field};
...
impl<E: PairingEngine> Prover<E> {
    ...
    pub fn prove_with_preprocessed(
        ...
        let beta = TranscriptProtocol::<E>::challenge_scalar(&mut transcript, b"beta");
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"beta", &beta);
        let gamma = TranscriptProtocol::<E>::challenge_scalar(&mut transcript, b"gamma");
        ...
        let z_challenge = TranscriptProtocol::<E>::challenge_scalar(&mut transcript, b"z");
        ...
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"a_eval", &evaluations.proof.a_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"b_eval", &evaluations.proof.b_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"c_eval", &evaluations.proof.c_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"d_eval", &evaluations.proof.d_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"a_next_eval", &evaluations.proof.a_next_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"b_next_eval", &evaluations.proof.b_next_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"d_next_eval", &evaluations.proof.d_next_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"left_sig_eval", &evaluations.proof.left_sigma_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"right_sig_eval", &evaluations.proof.right_sigma_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"out_sig_eval", &evaluations.proof.out_sigma_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"q_arith_eval", &evaluations.proof.q_arith_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"q_c_eval", &evaluations.proof.q_c_eval);
        //transcript.append_scalar(b"q_l_eval"(&mut transcript,  &evaluations.proof.q_l_eval);
        //transcript.append_scalar(b"q_r_eval"(&mut transcript,  &evaluations.proof.q_r_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"perm_eval", &evaluations.proof.perm_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"t_eval", &evaluations.quot_eval);
        TranscriptProtocol::<E>::append_scalar(&mut transcript, b"r_eval", &evaluations.proof.lin_poly_eval);
